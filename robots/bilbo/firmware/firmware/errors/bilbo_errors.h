...
#ifndef ERRORS_BILBO_ERRORS_H_
#define ERRORS_BILBO_ERRORS_H_
...
public:
	...
	bilbo_logging_error_t getSample();
...
//void bilbo_error_handler(uint32_t errorcode);
//void bilbo_error_handler(uint32_t errorcode, uint8_t *data, uint16_t len);

#endif /* ERRORS_BILBO_ERRORS_H_ */
