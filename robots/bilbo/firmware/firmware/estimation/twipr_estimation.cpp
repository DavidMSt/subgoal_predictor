...
void TWIPR_Estimation::init(twipr_estimation_config_t config) {
	...
	if (this->config.velocity_filter_config.enable) {
		...
		const float dt = TWIPR_ESTIMATION_TS;
...
void TWIPR_Estimation::update() {
	...
	if (this->config.position_ekf_config.enable) {
		...
		_ekf_predict(v, psi_dot, TWIPR_ESTIMATION_TS);
...
/* ======================================================= */
void TWIPR_Estimation::set_position_state(
...
/* ======================================================= */
inline float TWIPR_Estimation::_lpf1_update(float x) {
...
/* ======================================================= */
void TWIPR_Estimation::set_position_update(bilbo_position_state_t position_state) {
	_position_update = position_state;
	_position_update_available = true;
}
/* ======================================================= */
velocity_lowpass_filter_config_t TWIPR_Estimation::get_velocity_lpf_config() {
	return this->config.velocity_filter_config;
}
/* ======================================================= */
void TWIPR_Estimation::set_velocity_lpf_config(velocity_lowpass_filter_config_t new_config) {
...
/* ======================================================= */
psi_dot_lowpass_filter_config_t TWIPR_Estimation::get_psi_dot_lpf_config() {
	return this->config.psi_dot_filter_config;
}
/* ======================================================= */
void TWIPR_Estimation::set_psi_dot_lpf_config(psi_dot_lowpass_filter_config_t new_config) {
...
/* ======================================================= */
inline float TWIPR_Estimation::_lpf_psi_dot_update(float x) {
	// Optional "initialize on first sample"
...
/* ======================================================= */
void TWIPR_Estimation::set_dead_reckoning_enable(bool enable) {
...
/* ======================================================= */
void TWIPR_Estimation::_ekf_init() {
...
/* ======================================================= */
void TWIPR_Estimation::_ekf_predict(float v, float psi_dot, float dt) {
	// Current state
