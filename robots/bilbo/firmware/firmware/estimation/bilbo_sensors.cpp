...
BILBO_Sensors::BILBO_Sensors() {

}

/* ======================================================= */
uint8_t BILBO_Sensors::init(bilbo_sensors_config_t config) {
	...
	if (!success) {
		...
		this->status = BILBO_SENSORS_STATUS_ERROR;
		return 0;
	}

	this->_config = config;

	this->status = BILBO_SENSORS_STATUS_IDLE;
	return 1;
}
/* ======================================================= */
void BILBO_Sensors::start() {
	this->status = BILBO_SENSORS_STATUS_RUNNING;
}
/* ======================================================= */
uint8_t BILBO_Sensors::check() {
...
/* ======================================================= */
void BILBO_Sensors::update() {
	this->_readImu();
	this->_readMotorSpeed();
	this->_readBatteryVoltage();
}
/* ======================================================= */
bilbo_sensors_data_t BILBO_Sensors::getData() {
	return this->_data;
}
/* ======================================================= */
bilbo_sensors_status_t BILBO_Sensors::getStatus() {
	return this->status;
}
/* ======================================================= */
uint8_t BILBO_Sensors::calibrate() {
	//TODO
...
/* ======================================================= */
void BILBO_Sensors::_readMotorSpeed() {
...
/* ======================================================= */
void BILBO_Sensors::_readBatteryVoltage() {
