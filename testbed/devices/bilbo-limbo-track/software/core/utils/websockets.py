...
class SyncWebsocketServer_Events:
    ...
    message: Event = Event(copy_data_on_set=False)
...
class WebsocketServer:
    ...
    def _on_message_received(self, client, server, message):
        ...
        try:
            ...
            self.logger.debug(f"Non-JSON message from {client['address']}, dropping.")
            return
        ...
        self.callbacks.message.call(data, websocket_client)
