...
#     )
#     sim.add_agent(ag1)
#     sim.mpi.agent_motion_planning(ag1, solution_phase_name="goal", goal_task= )
...
def mp_task_1ag_1obs():
    ...
    sim.mpi.agent_motion_planning(ag1, solution_phase_name="goal", goal_task= task1.container)
