...
def setup_simple_maze(demo):
    ...
    demo.newObstacle("wall_top", x=0.0, y=2.5, length=5.0, width=0.2)
    demo.newObstacle("wall_bottom", x=0.0, y=-2.5, length=5.0, width=0.2)
    demo.newObstacle("wall_left", x=-2.5, y=0.0, length=5.0, width=0.2)
    demo.newObstacle("wall_right", x=2.5, y=0.0, length=5.0, width=0.2)
    
    # Internal obstacles to create maze paths
    demo.newObstacle("obs1", x=-1.0, y=0.0, length=2.0, width=0.2)
    demo.newObstacle("obs2", x=1.0, y=0.5, length=2.0, width=0.2)

    # Add goal task
    demo.newTask("goal1", x=2.0, y=2.0, color=[0, 1, 0])  # Green goal at (2, 2)
