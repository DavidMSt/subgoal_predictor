...
def maze_multi_4x4(demo):
    ...
    # Positioned to require navigation through the maze
    ...
    # Positioned at the bottom to require navigation through the maze
    demo.newTask("goal1", x=-1.75, y=-1.75, color=[0, 1, 0])
    demo.newTask("goal2", x=0.0, y=-1.75, color=[1, 1, 0])
    demo.newTask("goal3", x=1.75, y=-1.75, color=[0, 0, 1])
