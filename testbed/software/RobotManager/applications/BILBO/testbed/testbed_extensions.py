...
from applications.BILBO.testbed.testbed_display import TestbedDisplayClient
from applications.BILBO.testbed.testbed_limbo_bar import TestbedLimboBar
from core.utils.exit import register_exit_callback
from core.utils.logging_utils import Logger


class BILBO_TestbedExtensions:
    limbo_bar: TestbedLimboBar
    ...
    def __init__(self):
        ...
        self.limbo_bar = TestbedLimboBar()
