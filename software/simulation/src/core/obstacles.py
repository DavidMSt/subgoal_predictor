...
import numpy as np
from simulation.src.utils.orientations import psiFromRotMat
import simulation.src.core as core


# from EnvironmentDavid.Tests.Test_Environment import EnvironmentDavid_thisExample

#
# class Obstacle(core.environment.Object, ABC):
...
#                  world: core.world.Environment = None, *args,
#                  **kwargs):
